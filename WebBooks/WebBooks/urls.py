...
urlpatterns = [
    ...
    re_path(r'^books/(?P<pk>\d+)$', views.BookDitailView.as_view(), name="book-detail"),
    re_path(r'^authors/$', views.AuthorListlView.as_view(), name='authors'),
    re_path(r'^mybook/$', views.LoanedBookByUserListView.as_view(), name='my-borrowed'),
